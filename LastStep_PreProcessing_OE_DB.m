...
switch ExpeInfo.PreProcessingInfo.IsThereEphys
    case 'Yes'
        ...
        for f = 1:length(ExpeInfo.PreProcessingInfo.FolderForConcatenation_Ephys)
            ...
            [~, out_ind] = regexp(ExpeInfo.PreProcessingInfo.FolderForConcatenation_Ephys{f}, 'recording\d/');
            StartFile = dir([ExpeInfo.PreProcessingInfo.FolderForConcatenation_Ephys{f}(1:out_ind) '*.oebin']);
            ...
            %% Make TTLInfo
            TTLInfo_sess{f} = MakeData_TTLInfo_OpenEphys([ExpeInfo.PreProcessingInfo.FolderForConcatenation_Ephys{f}(1:out_ind) ...
                'events/Rhythm_FPGA-100.0_TTL_1.mat'],ExpeInfo.PreProcessingInfo.FolderForConcatenation_Ephys{f}(1:out_ind),...
                ExpeInfo);
