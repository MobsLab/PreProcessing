...
switch ExpeInfo.PreProcessingInfo.IsThereEphys
    case 'Yes'
        ...
        for f = 1:length(ExpeInfo.PreProcessingInfo.FolderForConcatenation_Ephys)
            ...
            %% Check if you have the position decoder data
            if exist([ExpeInfo.PreProcessingInfo.FolderForConcatenation_Ephys{f}(1:out_ind-1) ...
                    'events/Position_Decoder-103.0_TTL_1.mat'], 'file')
